...
Ниже приведен пример заполнения слоя данных `digitalData` для страницы "Спасибо за покупку"
...
### <a name="0"></a>Введение
------
На странице "Спасибо за покупку" интернет-магазина должны быть объявлены и заполнены следующие объекты:
 - Обязательные:  `transaction`, `page`, `website`, `user`, `cart`, `version`
...
------
Объект `digitalData.transaction` должен быть объявлен и заполнен на странице "Спасибо за покупку".

[Подробнее об объекте **transaction**](/ru/digitaldata/transaction)
...
### <a name="4"></a>cart
------
На странице "Спасибо за покупку" объект `digitalData.cart`  должен описывать пустую корзину
