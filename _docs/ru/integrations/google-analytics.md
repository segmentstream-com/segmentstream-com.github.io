...
SegmentStream позволяет с легкостью отправлять данные о поведении ваших пользователей в [Google Analytics](https://analytics.google.com/). После полной [интеграции digitalData с вашим сайтом](/for-developer/), можно перейти к настройке интеграции в панели SegmentStream.
...
>Важно! Событие [Viewed Page](/events/viewed-page) автоматически преобразуется к типу взаимодействия pageview и не попадают в отчет Behaviour > events > top events
